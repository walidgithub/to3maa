...
class DbHelper {
  ...
  Future createDB(Database db, int version) async {
    ...
    await db.execute(
        'create table zakatProducts(id integer primary key autoincrement, productName varchar(255), productPrice varchar(10), productDesc varchar(255), productQuantity integer, zakatId integer)');

    await db.execute(
        'create table productsData(id integer primary key autoincrement, productName varchar(255), productPrice varchar(10), productDesc varchar(255))');
  }
