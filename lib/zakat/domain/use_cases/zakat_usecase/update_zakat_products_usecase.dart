...
class UpdateZakatProductsUseCase extends BaseUsecase {
  final BaseRepository baseRepository;

  UpdateZakatProductsUseCase(this.baseRepository);

  @override
  Future<Either<Failure, int>> call(parameters) async {
    return await baseRepository.updateZakatProductsData(parameters);
  }
}