...
class DeleteMembersCountUseCase extends BaseUsecase {
  final BaseRepository baseRepository;

  DeleteMembersCountUseCase(this.baseRepository);

  @override
  Future<Either<Failure, int>> call(parameters) async {
    return await baseRepository.deleteMembersCount(parameters);
  }
}
