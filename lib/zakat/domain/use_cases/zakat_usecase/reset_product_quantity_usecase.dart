...
class ResetProductQuantityUseCase extends BaseUsecase {
  final BaseRepository baseRepository;

  ResetProductQuantityUseCase(this.baseRepository);

  @override
  Future<Either<Failure, int>> call(parameters) async {
    return await baseRepository.resetProductQuantityData(parameters);
  }
}
