...
class GetTotalOfPurchasesUseCase extends BaseUsecase<double, NoParameters> {
  final BaseRepository baseRepository;

  GetTotalOfPurchasesUseCase(this.baseRepository);

  @override
  Future<Either<Failure, double>> call(NoParameters parameters) async {
    return await baseRepository.getTotalOfPurchases();
  }
}
